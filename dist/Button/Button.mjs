...
const Button = forwardRef(({ onClick, disabled = false, children, type = "button", fullWidth = false, size = "md", square = false, active = false, onTouchStart = noOp, primary = false, variant = "default", ...otherProps }, ref) => {
  return React__default.createElement(StyledButton, { "$active": active, disabled, "$disabled": disabled, "$fullWidth": fullWidth, onClick: disabled ? void 0 : onClick, onTouchStart, "$primary": primary, ref, "$size": size, "$square": square, type, "$variant": variant, ...otherProps }, children);
});
