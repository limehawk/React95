...
type SelectChangeEventTargetValue<T> = {
    value: T;
    name: string | undefined;
};
export type SelectChangeEvent<T> = (Omit<React.ChangeEvent<HTMLSelectElement>, 'target'> & {
...
export type SelectFormatDisplayCallback<T> = (option: SelectOption<T>) => string;
